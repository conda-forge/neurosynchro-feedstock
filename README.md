About neurosynchro-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/neurosynchro-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/pkgw/neurosynchro

Documentation: http://neurosynchro.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5083&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/neurosynchro-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `neurosynchro` can be installed with `conda`:
...
```
mamba install neurosynchro
```

It is possible to list all of the versions of `neurosynchro` available on your platform with `conda`:
...
```
mamba search neurosynchro --channel conda-forge
```
...
mamba repoquery search neurosynchro --channel conda-forge

# List packages depending on `neurosynchro`:
mamba repoquery whoneeds neurosynchro --channel conda-forge

# List dependencies of `neurosynchro`:
mamba repoquery depends neurosynchro --channel conda-forge
```
